...
public:
    ...
    void setSelectedElements(const QList<int>& indexes);
...
signals:
    ...
    void elementsSelected(const QList<int>& indexes);
    void elementMoved(int index, double xInches, double yInches);
    void elementChanged(int index, const LabelElement& element);
    void elementsChanged(const QList<int>& indexes, const QList<LabelElement>& elements);
...
private:
    ...
    QPointF groupDragStartInches_;
    QPointF marqueeStart_;
    QRectF marqueeRect_;
    QList<int> groupDragIndexes_;
    QList<LabelElement> groupDragStartElements_;
