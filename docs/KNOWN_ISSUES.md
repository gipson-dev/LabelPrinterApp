...
- Preview-to-print matching was improved again in `v1.0.4`; `v1.0.5` fixes the missing `zlib-ng2.dll` package dependency. Final vertical and horizontal offset checks still need real media validation.
