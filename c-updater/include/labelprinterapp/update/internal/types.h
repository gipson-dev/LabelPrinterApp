...
namespace labelprinterapp::update::internal::types
{

using verifier_func =
    std::function<void(labelprinterapp::update::types::verification_payload const&)>;
...
class base_verifier : public labelprinterapp::update::types::verifier
{
public:
