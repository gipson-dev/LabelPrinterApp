#ifndef LABELPRINTERAPP_UPDATE_MANAGER_H_
#define LABELPRINTERAPP_UPDATE_MANAGER_H_
...
#include "labelprinterapp/update/detail/launcher.h"
#include "labelprinterapp/update/detail/log.h"
#include "labelprinterapp/update/internal/sentinel.h"

#ifdef _WIN32
#include "labelprinterapp/update/internal/win/lock.h"
#include "labelprinterapp/update/internal/win/process.h"
...
public:
    ...
    void set_launcher(std::unique_ptr<labelprinterapp::update::launcher> launcher)
    {
...
private:
    ...
    std::unique_ptr<labelprinterapp::update::launcher> m_launcher{ nullptr };
...
#endif // LABELPRINTERAPP_UPDATE_MANAGER_H_
