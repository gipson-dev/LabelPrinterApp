#ifndef LABELPRINTERAPP_UPDATE_UPDATER_H_
#define LABELPRINTERAPP_UPDATE_UPDATER_H_
...
#include "labelprinterapp/update/detail/common.h"
#include "labelprinterapp/update/detail/downloader.h"
#include "labelprinterapp/update/detail/github.h"
#include "labelprinterapp/update/detail/log.h"
#include "labelprinterapp/update/detail/operations.h"
#include "labelprinterapp/update/detail/types.h"
#include "labelprinterapp/update/detail/verifiers.h"
#include "labelprinterapp/update/internal/sentinel.h"
#include "labelprinterapp/update/internal/util.h"
#include "labelprinterapp/update/manager.hpp"

#ifdef _WIN32
#include "labelprinterapp/update/internal/zip.h"
#endif

namespace labelprinterapp::update::internal
{
...
public:
    ...
    std::shared_ptr<labelprinterapp::update::manager> manager() { return m_manager; }

    // Returns the manager associated with this updater.
    std::shared_ptr<const labelprinterapp::update::manager> manager() const
    {
        return m_manager;
    }
...
private:
    ...
    std::shared_ptr<labelprinterapp::update::manager> m_manager;
...
#endif // LABELPRINTERAPP_UPDATE_UPDATER_H_
