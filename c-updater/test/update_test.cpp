...
using namespace labelprinterapp::update;
using namespace std::chrono_literals;

// Used test files:
// - https://labelprinterapp.github.io/update_test/github-api-mock/latest-simple.json
// Repository: https://github.com/labelprinterapp/update_test
// Test releases: https://github.com/labelprinterapp/update_test/releases

#ifdef _WIN32
// Use a name with characters that are represented different in Windows UTF-16.
std::wstring test_folder_name = L"labelprinterapp_update_t\u00E9st_dir";
...
static const char* MOCK_URL_GITHUB_API_DOWNGRADE_ATTACK =
    "https://labelprinterapp.github.io/update_test/github-api-mock/"
...
{
    http_downloader downloader("https://labelprinterapp.github.io");
...
{
    http_downloader downloader("https://labelprinterapp.github.io/update_test");
...
{
    downloader_inject downloader("https://labelprinterapp.github.io/update_test");
...
TEST(latest_extractor, YieldsLatestVersionWhenRequestingMockGitHubApi)
{
    ...
    EXPECT_EQ("https://github.com/labelprinterapp/update_test/releases/download/v1.2.3/"
              "release-1.2.3.txt",
        result.second.url());
    EXPECT_EQ("https://github.com/labelprinterapp/update_test/releases/download/v1.2.3/",
...
TEST(latest_retriever, YieldsLatestVersionWhenUsingOldGitHubUsername)
{
    ...
    const auto current_username = "labelprinterapp";
...
public:
    mock_github_api_latest_retriever(
        ...
        : github_api_latest_retriever("labelprinterapp", "update_test")
    {
...
public:
    ...
    std::unique_ptr<labelprinterapp::update::launcher> launcher() const
    {
        ...
        return std::make_unique<labelprinterapp::update::launcher>(m_executable, dlls);
    }
...
TEST(updater, UsesAlternateUrlWhenUrlIsOverridden)
{
    ...
    updater.override_file_url("SHA256SUMS.txt", [&](auto const& version) {
        ...
        return "https://labelprinterapp.github.io/update_test/other-host/SHA256SUMS.txt";
    });
    updater_update_test(updater, "release-1.2.3.txt", false);
}
